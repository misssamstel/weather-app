import { UPDATE_WEATHERDESC_TEMP, UPDATE_LAT_LONG, UPDATE_LOCATION, SET_CURRENT_DATE, GET_FIVE_DAY_WEATHER, ADD_ERROR, CLEAR_ERROR } from '../constants/action-types';
...
export const getFiveDayWeather = fiveDayWeather => ({ type: GET_FIVE_DAY_WEATHER, payload: fiveDayWeather });
